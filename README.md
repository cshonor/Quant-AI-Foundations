...
| 阶段 | 目录 | 内容 |
|------|------|------|
| 阶段1 | `CO/CMU-Stage1.Foundations_and_Core_Tools/` | 导论、凸性、标准形式、梯度下降、次梯度/近端梯度（讲座1–8） |
| 阶段2 | `CO/CMU-Stage2.Advanced_Theory_and_Complex_Algorithms/` | 对偶、KKT、牛顿法、ADMM 等（讲座9–22） |
| 阶段3 | `CO/CMU-Stage3.Extensions_and_Special_Scenarios/` | 坐标下降、混合整数规划（讲座23–25） |
...
2. **CO**：按阶段进入 `CO/CMU-Stage*/`，各阶段内有二级讲座目录（如 `01.Introduction`、`05-06.Gradient_Descent`）。
